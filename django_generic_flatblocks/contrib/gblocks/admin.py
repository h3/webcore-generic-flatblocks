...
if 'grappellifit' in settings.INSTALLED_APPS and 'modeltranslation' in settings.INSTALLED_APPS:
    ...
    admin.site.register(TranslatedTitleAndFile, TranslationAdmin)
    admin.site.register(TranslatedImageAndLink, TranslationAdmin)
    admin.site.register(TranslatedTitleTextAndImage, TranslationAdmin)
    ...
    admin.site.register(TranslatedImageAndLink)
    admin.site.register(TranslatedTitleAndFile)
    admin.site.register(TranslatedTitleTextAndImage)
